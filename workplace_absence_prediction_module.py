# -*- coding: utf-8 -*-
"""workplace_absence_prediction_module.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1OSLy-JX2crhw4CmYHYY36ICY9tfvuA6n
"""
...
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            # create a list with Months retrieved from the 'Date' column
            list_months = []
            for i in range(df.shape[0]):
                list_months.append(df['Date'][i].month)
            print(list_months)
            # insert the values in a new column in df, called 'Month'
            df['Month'] = list_months

            def date_to_weekday(date_value):
              return date_value.weekday()

            # create a new feature called 'Weekday'
